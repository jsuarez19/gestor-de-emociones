...
const emotionsData = {
  ...
  emotions: {
    Amor: {
      group: "Agradables",
      emoji: "❤️",
      impulso_accion: "Dar cosas, dedicar tiempo, buscar cercanía.",
    ...
    Asco: {
      ...
      acciones_no_justificada: "Explorar nuestros prejuicios, practicar la compasión y empatía."
    },
    ...
    Vergüenza: {
      group: "Desagradables",
      emoji: "😳",
      impulso_accion: "Evitar lo que genera esa emoción, taparse la cara, el silencio repentino o achicar la postura.",
    ...
    Culpa: {
      group: "Desagradables",
      emoji: "😔",
      impulso_accion: "Reparar, pedir disculpas reiterativas, aislarse, castigarse.",
    ...
    Desprecio: {
      group: "Desagradables",
      emoji: "😤",
      impulso_accion: "Querer que lo que despreciamos se aleje de nosotros, expresiones faciales negativas, comentarios despectivos, evitar situaciones sociales o desvinculación emocional.",
      ...
      acciones_no_justificada: "Explorar prejuicios, practicar la aceptación y la tolerancia."
    },
